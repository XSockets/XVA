...
namespace CustomProtocolBasic.Client
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //A subscription for the topic "bar" on the controller "foo", 5 means subscribe (see https://uffebjorklund.gitbooks.io/xsockets-net-5/content/controllers/reserved_topics.html)
            var subscription = Encoding.UTF8.GetBytes("foo|5|bar");
