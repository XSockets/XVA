...
{ 
    ...
    public class ConnectionBroker : XSocketController, IConnectionBroker
    {
        ...
        public void Receivefile(IMessage fileMessage)
        {
         //   this.InvokeToOthers(fileMessage);


            this.Find(p => p.ConnectionId != this.ConnectionId).ToList().
                ForEach(m => m.Invoke(fileMessage));
